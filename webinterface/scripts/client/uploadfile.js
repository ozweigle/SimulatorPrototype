...
(function (e) {
    if (e.fn.ajaxForm == undefined) {
        e.getScript("scripts/client/jquery.form.js")
    }
    var t = {};
    ...
    e.fn.uploadFile = function (n) {
        ...
        var r = e.extend({
            ...
            dragDropStr: '<span class="ajax-dragdrop-string" style="float: right; margin-top: 5px;">Drag & Drop File</span>',
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
        ...
        var s = this;
        var buttonName=e(this).html()
        var o = e('<div class="ajax-upload-button">' + buttonName + "</div>");
        ...
        (function b() {
            if (e.fn.ajaxForm) {
                if (r.dragDrop) {
                    ...
                    e(s).before(t);
                    e(t).append(o);
                    e(t).append('<span class="ajax-upload-file" style="display:inline-block; vertical-align:top; margin-top: 5px;" id="' + buttonName + '_file">' + " " + "</span>")
